 ...
 * @author sulev
 */
public class TakipEdilenler extends javax.swing.JFrame {
Connection baglanti = null;
    ...
    public void TabloyuGoster(int username) {
        try {
            ...
            String SQLSorgusu = "SELECT KullaniciAdi FROM kullanici k inner join kullanicilarintakipcileri kt on k.KullaniciID=kt.KullaniciiID WHERE TakipciID = '"
                    + username
                    + "'";
    ...
    private void initComponents() {
        ...
        jTextField2.setText("                  TAKİP EDİLENLER");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TakipEdilenler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
